...
# ! ZONA CONFLICTIVIDAD  ->  ÚTIL PARA VER DIFERENCIAS ENTRE HEURÍSTICAS, debilidad de las heuristicas 3,4 y 5
...
# Nota: va a tardar mucho tiempo debido a la cantidad de alumnos que hay
